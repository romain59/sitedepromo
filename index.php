...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
                <div class="container-presentation">Portée par FACE Thiérache, club d'entreprises de Fourmies, l'école du Numérique "Up To", labellisée Grande École du Numérique par l'Etat est ouverte depuis le 1er octobre 2018. <br><br>
                Up To intègre le réseau des fabriques du numérique de Simplon. <br><br>
                Up To véhicule des valeurs de solidarité, d'entraide dans une démarche inclusive. <br><br>
                L'objectif est de former des talents aux métiers du Numérique et répondre aux besoins de compétences en pénurie des entreprises.<br><br>
                Up To est  parrainée par l'entreprise Comm'uniq de Fourmies.<br><br>
