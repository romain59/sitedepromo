...
<head>
    <meta charset="UTF-8">
    <title>Remerciements| Up To Fourmies</title>
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <div class="container-groupe">
                <div class="row">
                    <h1 id="text"><i>#</i> REMERCIEMENTS</h1>
                </div>
            </div>
        </div>
    </div>
...
<section class="container">
    ...
    <div  class="row">
        ...
        <div id="titreremerciements" class="col-sm-8 mb-4 mt-4 text-center">
    ...
    <div class="CaseRemerciements" class="mt-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-2  mt-4 ml-4">
                ...
                <a href=" https://www.fondationface.org/face-thierache/" target="_blank">
                    <img id="img1" src="image/logoface.jpg" alt="Photo de Face Thiérache">
                </a>
            ...
            <div class="col-sm-8 mt-4  ml-4"></div>
    ...
    <div class="CaseRemerciements" class="mt-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-2  mt-4 ml-4">
                ...
                <a href = "http://www.gipreussir.fr/" target="_blank"><img id="img1" src="http://www.gipreussir.fr/images/resa.jpg" alt="Logo de Réussir En Sambre-Avesnois"></a>
    ...
    <div class="CaseRemerciements" class="mt-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-4 ml-4 text-center">
                ...
                <span><a id="sous-pref" href="http://www.nord.gouv.fr/Services-de-l-Etat/Horaires-et-coordonnees/Sous-prefecture-d-Avesnes-sur-Helpe" style="color:#29898f" target="_blank">Lien vers la sous-préfecture d'Avesnes-sur-Helpe</a></span>
...
<br>
    ...
    <div class="CaseRemerciements" class="mt-5">
        ...
        <div class="row">
            ...
            <div class="col-sm-2  mt-4 ml-4">
                ...
                <a href="https://simplon.co/" target="_blank">
                    <img id="img3" src="image/Simplon.jpg" alt="Logo Simplon">
                </a>
            </div>
        ...
        <div class="row">
            ...
            <div id="Para1" class="col-sm-8 mb-4 ml-4">
                ...
                <p> Nous remercions Simplon.</p>
                <p> Simplon est un réseau de fabriques numériques et inclusives en France et à l’étranger. Ils ont formé plus de 2000 apprenants aux métiers du numérique depuis 2013.</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-4 ml-4 text-center">
                ...
                <span><a id="sous-pref" href="https://simplon.co/" style="color:#ffffff" target="_blank">Lien vers le site de Simplon</a></span>
    ...
    <div id="CaseRemerciements2" class="mb-5">

        <div class="row">


            <div class="col-sm-12 mb-4 mt-4 ml-5">

                <img id="img2" src="image/logopartenaires.jpg" width="1000" alt="Photo de Partenaire">
...
<footer>
    <div class="col-12" id="boutonRetour" >
        <a href="#retour"><img src="image/b-up.png" width="40" alt="Bouton Retour"></a>
    </div>
    <div class="containerFooter">
        <div class="row">
            <div class="col-sm-5">
                <img id="logoFup" src="image/logo_ecn.jpg" height="100" alt="Logo ecn" >
            </div>
            <div class="col-sm-2">
                <a href="Contacts.php"><span id="contactFooter" class="btn btn-default btn-lg btn-block">Contactez-nous!</span></a>
            </div>
            <div class="col-sm-5">
                <img id="logoFace" src="image/logoface.jpg" height="100" alt="logo Face" >
            </div>
